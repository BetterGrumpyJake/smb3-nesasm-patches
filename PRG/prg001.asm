...
ObjectGroup00_InitJumpTable:
	.word ObjInit_Galoomba	; Object $00
...
ObjectGroup00_NormalJumpTable:
	.word ObjNorm_Galoomba	; Object $00
...
ObjectGroup00_Attributes:
	.byte OA1_PAL3 | OA1_HEIGHT16 | OA1_WIDTH16	; Object $00
...
ObjectGroup00_Attributes3:
	.byte OA3_HALT_NORMALONLY | OA3_DIESHELLED 	; Object $00
...
ObjectGroup00_KillAction:
	.byte KILLACT_JUSTDRAW16X16	; Object $00
...
Galoomba_XVel:	.byte $08, -$08

ObjInit_Galoomba:
	JSR Level_ObjCalcXDiffs			;Y=0 or 1 from this depending if mario is on the right/left
	
;Bowser_FlipToFace: .byte SPR_HFLIP, $00
	LDA Bowser_FlipToFace,Y			;reusing bowser_fliptoface because it's here
	STA Objects_FlipBits,X			;same as xvel, flip or don't
...
ObjNorm_Galoomba:
	...
	LDA <Player_HaltGame
	BNE Galoomba_Ret				;if gameplay halted, RTS
	
	JSR Object_Move
	
	LDA Objects_Timer3,X			;if this timer is set he hasn't woke up, do not move
	BNE Galoomba_Shelled			;also reshell, since the throw logic in prg0 sets its state as normal
	
	JSR Object_HandleBumpUnderneath

	LDY #$01						;convert facing direction into x vel
	LDA Objects_FlipBits,X
	AND #SPR_HFLIP
	BEQ Galoomba_Face
	DEY
Galoomba_Face:
	LDA Galoomba_XVel,Y				;Y=0($08) or 1(-$08)
	STA <Objects_XVel,X
	
	LDA <Objects_DetStat,X			;check ground
	AND #$04
	BEQ Galoomba_Wall	 			;if galoombas not on ground, check wall
...
;walk animation only on ground
	LDA <Counter_1
	AND #$08
	BEQ Galoomba_Walk				;every 8 ticks swap the frame
	LDA #$01
Galoomba_Walk:
	STA Objects_Frame,X				;frame 0 or 1

Galoomba_Wall:
	LDA <Objects_DetStat,X			;check wall
	AND #$03
	BEQ Galoomba_Ret
	JMP Object_AboutFace
