...
SpawnEmptyBoot:
	LDX #$04
SpawnEmptyBoot_FindSlot:			;find empty slot
	LDA Objects_State,X
	BEQ SpawnEmptyBoot_SlotFound
	DEX
	BPL SpawnEmptyBoot_FindSlot

	BMI SpawnEmptyBoot_Done

SpawnEmptyBoot_SlotFound:
	JSR Level_PrepareNewObject

	LDA #OBJSTATE_NORMAL
	STA Objects_State,X
	;LDA #SPR_PAL2					;OBJSTATE_NORMAL is already 02, set palette to 02 as well
	STA Objects_SprAttr,X

	LDA #OBJ_GOOMBAINSHOE
	STA Level_ObjectID,X

	LDA #$01
	STA <Objects_Var4,X	 			;var4=1: shoe spawns empty
	...
	LDA #$10						;cooldown before you can enter boot again
	...
	LDA <Player_InAir
	BNE SpawnEmptyBoot_Done
	LDA #-$30
	STA <Objects_YVel,X

SpawnEmptyBoot_Done:
	LDX <SlotIndexBackup
	PLA								;no longer in boot, no need to go back to Move_Kuribo
	PLA
	RTS